			...
			<div class="form-control-border form-control-transparent form-fs-md d-flex">
				...
				<div class="flex-grow-1">
					<select class="form-select js-choice" data-search-enabled="true" id="search">
						<option selected value="">회원 선택</option>
						<c:forEach var="memVO" items="${memList}" varStatus="stat">
							<option value="${memVO.memId}">${memVO.memNm}(${memVO.memId})</option>
						</c:forEach>
					</select>
				</div>
			</div>
