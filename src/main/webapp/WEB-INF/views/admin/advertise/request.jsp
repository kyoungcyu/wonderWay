		...
		<div class="page-content-wrapper p-xxl-4">
			...
			<div class="row g-4">
				...
				<div class="col-sm-6 col-xxl-3">
					<div class="card card-body bg-light p-4 h-100">
						<h6 class="mb-0">전체 미처리 요청 수</h6>
						<br />
						<h4 class="mb-2 mt-2">
							<a href="/admin/advertise/request?currentPage=${data.startPage}&keyword=${param.keyword}&sort=${param.sort}&period=${param.period}&adId=">${cntAdvReqAll }</a>
						</h4>
					</div>
				</div>
				...
				<div class="col-sm-6 col-xxl-3">
					<div class="card card-body bg-light p-4 h-100">
						<h6 class="mb-0">메인 배너 요청</h6>
						<br />
						<h4 class="mb-2 mt-2">
							<a href="/admin/advertise/request?currentPage=${data.startPage}&keyword=${param.keyword}&sort=${param.sort}&period=${param.period}&adId=V01">${cntAdvReqMain }</a>
						</h4>
					</div>
				</div>
				...
				<div class="col-sm-6 col-xxl-3">
					<div class="card card-body bg-light p-4 h-100">
						<h6 class="mb-0">하단 배너 요청</h6>
						<br />
						<h4 class="mb-2 mt-2">
							<a href="/admin/advertise/request?currentPage=${data.startPage}&keyword=${param.keyword}&sort=${param.sort}&period=${param.period}&adId=V02">${cntAdvReqUnder }</a>
						</h4>
					</div>
				</div>
				...
				<div class="col-sm-6 col-xxl-3" >
					<div class="card card-body bg-light p-4 h-100">
						<h6 class="mb-0">최상단 노출 요청</h6>
						<br />
						<h4 class="mb-2 mt-2">
							<a href="/admin/advertise/request?currentPage=${data.startPage}&keyword=${param.keyword}&sort=${param.sort}&period=${param.period}&adId=V03">${cntAdvReqSearch }</a>
						</h4>
					</div>
				</div>
			</div>
			...
			<form class="card-header border-bottom" id="frm01">
				<div class="row g-4 align-items-center">
					<div class="col-lg-5">
						<h5 class="h4 mb-3 mb-sm-0">광고 요청
					...
					<div class="col-md-6 col-lg-2">
						<select class="form-select js-choice" aria-label=".form-select-sm" name="sort" id="sort">
							...
							<option value="payDtAsc" <c:if test="${param.sort=='payDtAsc'}">selected</c:if>>요청 일자 ↑</option>
							<option value="payDtDesc" <c:if test="${param.sort=='payDtDesc'}">selected</c:if>>요청 일자 ↓</option>
						</select>
					</div>
				</div>
			</form>
