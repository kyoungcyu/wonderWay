		...
		<div class="row">
			<div class="col-12 mb-4 mb-sm-5">
				<div class="d-sm-flex justify-content-between align-items-center">
					<h1 class="h3 mb-3 mb-sm-0">숙박 업체 조회 &ensp;&ensp;<a id="downloadExcel" href="#" class="btn btn-outline-primary btn-round mb-0"><i class="bi bi-cloud-download"></i></a></h1>
				</div>
			</div>
		</div>
		...
		<div class="row g-4">
			...
			<div class="col-sm-6 col-xxl-3">
				<div class="card card-body bg-light p-4 h-100">
					<h6 class="mb-0">전체 숙박 업체수</h6>
					<h4 class="mb-2 mt-2 text-end">
						<fmt:formatNumber type="number" pattern="#,###" value="${enable + disable}" />개
					</h4>
			...
			<div class="col-sm-6 col-xxl-3">
				<div class="card card-body bg-light p-4 h-100">
					<h6 class="mb-0">분류별 업체수</h6>
					<h5 class="mb-2 mt-2 text-end">
						<a href="/admin/busi/sty?keyword=&sort=호텔"> 호텔 <fmt:formatNumber type="number" pattern="#,###" value="${hotel}" />개 </a>
					</h5>
					<h5 class="mb-2 mt-2 text-end">
						<a href="/admin/busi/sty?keyword=&sort=모텔"> 모텔 <fmt:formatNumber type="number" pattern="#,###" value="${motel}" />개 </a>
					</h5>
				</div>
			</div>
			...
			<div class="col-sm-6 col-xxl-3">
				<div class="card card-body bg-light p-4 h-100">
					<h6 class="mb-0">분류별 업체수</h6>
					<h5 class="mb-2 mt-2 text-end">
						<a href="/admin/busi/sty?keyword=&sort=리조트"> 리조트 <fmt:formatNumber type="number" pattern="#,###" value="${resort}" />개 </a>
					</h5>
					<h5 class="mb-2 mt-2 text-end">
						<a href="/admin/busi/sty?keyword=&sort=게스트하우스"> 게스트하우스 <fmt:formatNumber type="number" pattern="#,###" value="${ghouse}" />개 </a>
					</h5>
					<h5 class="mb-2 mt-2 text-end">
						<a href="/admin/busi/sty?keyword=&sort=펜션"> 펜션 <fmt:formatNumber type="number" pattern="#,###" value="${pension}" />개 </a>
					</h5>
				</div>
			</div>
				...
				<div class="col-md-6 col-lg-4 col-xxl-3">
					<div class="card border h-100">
						...
						<div class="card-footer d-flex gap-3 align-items-center">
							<a href="/admin/busi/styDetail?busiId=${busiVO.busiId}" class="btn btn-sm btn-primary-soft mb-0 w-100">View detail</a>
				...
				<nav class="mb-sm-0 d-flex justify-content-center" aria-label="navigation">
					<ul class="pagination pagination-sm pagination-primary-soft mb-0 ">
						<li class="page-item <c:if test='${data.startPage < 6}'>disabled</c:if>" id="dataTable_previous">
							<a class="page-link" href="/admin/busi/sty?currentPage=${data.startPage-5}&sort=${param.sort}&keyword=${param.keyword}" aria-controls="dataTable" data-dt-idx="0"  tabindex="-1">Prev</a>
						</li>
						<c:forEach var="pNo" begin="${data.startPage}" end="${data.endPage}">
							<li class="page-item <c:if test='${param.currentPage eq pNo}'>active</c:if>">
								<a href="/admin/busi/sty?currentPage=${pNo}&sort=${param.sort}&keyword=${param.keyword}" aria-controls="dataTable" data-dt-idx="${pNo}" tabindex="0" class="page-link">${pNo}</a>
							</li>
						</c:forEach>
						<li class="page-item <c:if test='${data.endPage == data.totalPages}'>disabled</c:if>" id="dataTable_next">
							<a class="page-link" href="/admin/busi/sty?currentPage=${data.startPage+5}&sort=${param.sort}&keyword=${param.keyword}" aria-controls="dataTable" data-dt-idx="7"  tabindex="-1">Next</a>
						</li>
					</ul>
				</nav>
			</div>
