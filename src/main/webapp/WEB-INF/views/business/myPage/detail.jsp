		...
		$("#chckIn").on("click",function() {
			...
			console.log(
				"종료 시간 :"  + 	$("#finishH").val() +  "시"  ,
							    $("#finishM").val() +  "분"  );
			let data = {
				"chckIn" : $("#startH").val() + "시 " + $("#startM").val()  + "분",
				"chckOut" : $("#finishH").val()+ "시 " + $("#finishM").val() + "분"
				};
			console.log(JSON.stringify(data));
				$.ajax({
					type : "POST",
					url : "/business/myPage/chckInPost",
	...
	<main>
		<section class="pt-3">
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-8 col-xl-9">
						...
						<div class="vstack gap-4">
							...
							<div class="card-header border-bottom">
								<h4 class="card-header-title">숙소 체크인</h4>
							</div>
							
							<div class="card-columns" style="display: flex;">
								<div class="form-control-wrap">
									<div class="form-control" style="width: 440px; height: 100px; display: flex; justify-content: space-between; align-items: center;">
										<div class="text-success">Check In *</div>
			  ...
			  <input type="text" id="chat" class="form-control text-center" value="체크인 시간  : ${busiVO.chckIn} / 체크아웃 시간  : ${busiVO.chckOut}" disabled="true" />
			  <button type="button" id="chckIn" class="btn btn-primary" style="margin-left: 10px; margin-top:3px; height: 42px; width: 100px !important; font-size: 14px;">저장하기</button>
			</div>
