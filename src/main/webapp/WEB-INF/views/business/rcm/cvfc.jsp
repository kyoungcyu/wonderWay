...
border: thin solid #f7c32e !important;
border-radius: 10px;
}
...
$("#btnRcm").on("click",function(){
	...
	$.ajax({
			...
			success : function(result) {
				console.log(result)
				$("#rcm1").find('.fa').removeClass().addClass("fa "+result[0].icon);
				$("#rcm1").find('.mb-0').text(result[0].cvfcNm);
				$("#rcm2").find('.fa').addClass("fa "+result[1].icon);
				$("#rcm2").find('.mb-0').text(result[1].cvfcNm);
				$("#rcm3").find('.fa').addClass("fa "+result[2].icon);
				$("#rcm3").find('.mb-0').text(result[2].cvfcNm);
				$("#rcm410 li h6").each(function(index) {
				    $(this).text(result[index + 3].cvfcNm);
					$(this).find("i").removeClass().addClass("fa-solid "+result[index + 3].icon);
				});
			}
		});
	});
				...
				<div class="bg-warning bg-opacity-15 rounded-3 position-relative p-4 p-md-0">
					...
					<div class="row">
						<div class="col-md-7 text-center mx-auto py-md-5">
							<!-- Title -->
							<h6 class="text-primary">어떤 편의시설과 서비스를 추가해야할 지 고민이신가요?</h6>
							<h2 class="mb-4">AI가 추천하는 편의시설/서비스</h2>
							<p class="mb-4">나이와 성별을 입력하면 추가하면 좋을 편의시설/서비스 정보를 추천해드려요!</p>
							<div class="bg-body rounded-2 p-2">
									<select class="form-control border-0 me-1" id="age" >
										<option value="">타켓 연련층을 선택해주세요</option>
									...
									<select class="form-control border-0 me-1" id="gender" >
										<option value="">타겟 성별을 선택해주세요 </option>
										<option value="M" >남성</option>
										<option value="W" >여성</option>
									</select>
							</div>		
							<button id="btnRcm" type="button" class="btn btn-primary rounded-2 mt-3">추천받기</button>
						</div>
					</div> <!-- Row END -->
				</div>
			</div>
...
<div id="rstContainer" class="container">

<div class="col-md-7 mx-auto text-center justify-content-center py-md-5">
	<h5 class="mb-3 mb-lg-5">추천 결과</h5>

	<!-- Features START -->
	<div class="row">
		<!-- Item -->
		<!-- Item -->
		<div id="rcm1" class="col-sm-4" >
			<div class="icon-lg bg-danger bg-opacity-10 text-danger rounded-circle" style="margin:0 auto;"><i class="fa"></i></div>
			<div>
				<h5 class="mt-2">1위</h5>
				<p class="mb-0">&nbsp;</p>
			</div>
		...
		<!-- Item -->
		<div id="rcm2" class="col-sm-4">
			<div class="icon-lg bg-orange bg-opacity-10 text-orange rounded-circle" style="margin:0 auto;"><i class="fa"></i></div>
			<div>
				<h5 class="mt-2">2위</h5>
				<p class="mb-0">&nbsp;</p>
			</div>
		...
		<!-- Item -->
		<div id="rcm3" class="col-sm-4">
			<div class="icon-lg bg-info bg-opacity-10 text-info rounded-circle inline-block" style="margin:0 auto;"><i class="fa"></i></div>
			<div>
				<h5 class="mt-2">3위</h5>
				<p class="mb-0">&nbsp;</p>
			</div>
	...
	<div class="col-sm-6 mx-auto mt-5">
		<ul id="rcm410" class="list-group list-group-borderless mt-2 mb-0">
			<li class="list-group-item">
				<h6 class="fw-normal mb-0"><i></i>4위</h6>
			</li>

			<li class="list-group-item">
				<h6 class="fw-normal mb-0"><i></i>5위</h6>
			</li>

			<li class="list-group-item">
				<h6 class="fw-normal mb-0"><i></i>6위</h6>
			</li>

			<li class="list-group-item">
				<h6 class="fw-normal mb-0"><i ></i>7위</h6>
			</li>

			<li class="list-group-item">
				<h6 class="fw-normal mb-0"><i ></i>8위</h6>
			</li>

			<li class="list-group-item">
				<h6 class="fw-normal mb-0"><i ></i>9위</h6>
			</li>

			<li class="list-group-item">
				<h6 class="fw-normal mb-0"><i></i>10위</h6>
			</li>
		</ul>
	</div>
	<!-- Features END -->
