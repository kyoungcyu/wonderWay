							...
							<div class="row g-0">
								...
								<div class="col-lg-6 d-flex align-items-center order-2 order-lg-1">
									<div class="p-3 p-lg-5">
										<img
											src="/resources/booking/assets/images/forgotID.png"
											alt="">
									</div>
									<!-- Divider -->
								...
								<div class="col-lg-6 d-md-flex align-items-center order-1">
									<div class="p-3 p-lg-5">
										...
										<p class="mb-sm-0">이메일인증으로 아이디를 찾을 수 있습니다</p>
										...
										<form class="mt-sm-4 text-start">
											...
											<div class="mb-3">
												...
												<div class="d-flex">
													...
													<button type="button"
														class="btn btn-sm btn-primary ms-2 px-4 mb-0 "
														id="btnEmailCheck" style="background-color: #9400D3;">이메일 인증</button>
												</div>
											...
											<div class="d-grid">
												<button type="button" id="btnFindId" class="btn btn-primary"
													style="background-color: #9400D3;" >아이디 찾기</button>
											</div>
