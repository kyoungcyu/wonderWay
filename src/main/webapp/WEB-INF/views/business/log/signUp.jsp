								...
								<div
									...
									<div class="p-3 p-lg-5">
										...
										<a href=""> <img class="h-50px mb-4"
											src="/resources/booking/assets/images/logo.png" alt="logo">
										</a> <img
									...
									<div class="p-4 p-sm-6">
										...
										<!-- div블로 좌우로 정렬시킴!!!!!!!!!!!!!!!!!!!!!! -->
											    ...
											    <div class="row">
												    ...
												    <form id="FILE_FORM" method="post" enctype="multipart/form-data" action="http://127.0.0.1:5000/fileupload">
												    <div class="col-6">
													        ...
													        <br/>
													            ...
													            <a class="btn btn-primary-soft btn-user btn-sm content-end col-3" href="javascript:uploadFile();">사업자<br>정보<br>불러오기</a>
															</div>
												    </form>
											    </div>
												<a href="/business/log/aiTesting">시연영상보기 ></a>											
...
function uploadFile(){
		...
		$.ajax({
			...
			success : function(resp) {
				console.log(resp);
				var busi = resp.busi;
				var busiNm = resp.busiNm;
				var busiRepre = resp.busiRepre;
				var busiRepreBir = resp.busiRepreBir;
				var busiStart = resp.busiStart;
				var busiLocal = resp.busiLocal;
				
				$("#busiNm").attr("value", busiNm.replace(/\s/g, "")); // 상호명
				$("#nm").attr("value", busiRepre.replace(/\s/g, "")); // 성명
				// $("#bir").attr("value", busiRepreBir.replace(/\s/g, "")); // 생년월일
				$("#busiNo").attr("value", busi.replace(/\s/g, "")); // 등록번호
				$("#busiLoc").attr("value", busiLocal.replace(/\s/g, "")); //사업장위치
				$("#opbizYmd").attr("value", busiStart.replace(/\s/g, ""));	//개업년월일
