...
<section class="pt-0 pb-20">
	<div class="container">
		<!-- Background image -->
		<div class="rounded-3 p-3 p-sm-5" style="background-image: url(/resources/booking/assets/images/bg/trn.jpg); background-position: center center; background-repeat: no-repeat; background-size: cover;">
			<!-- Banner title -->
			<div class="row"> 
				<div class="col-md-10 mx-auto text-center"> 
					<h1 class="text-dark display-3 pt-sm-5 my-5">승차권 예매</h1>
				</div>
			</div>
              ...
              <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4 position-relative">
                  <div class="form-border-transparent form-fs-lg bg-light rounded-3 h-100 p-3">
                    ...
                    <%
						String[] locArray = {"서울역", "부산역","대구역","용산역","노량진역", "영등포역","신도림역","수원역","대전역"};
					%>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="form-border-transparent form-fs-lg bg-light rounded-3 h-100 p-3">
                    ...
                    <select class="form-select js-choice" name="arrPlace" data-search-enabled="true">
                      <option value="">도착역을 선택해주세요</option>
					  <% for (String loc:locArray) {%>
						<option><%=loc%></option>
					  <%}%>
                    </select>
