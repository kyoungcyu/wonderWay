		...
		<div class="row">
			<div class="col-12">
				...
				<div class="card card-body bg-primary justify-content-center text-center px-4 px-sm-5 pt-6 pt-md-8 pb-8" style="background-image: url(assets/images/element/bg-pattern.png); background-position: center center; background-repeat: no-repeat; background-size: cover;">
					<!-- Title -->
					<h1 class="fs-2 text-white mb-4">문의 수정</h1>
				</div>
			</div>
		</div>
		<!-- Hero banner END -->
					...
					<div class="col-lg-12">
						<div class="card p-4">
							...
							<div class="card-body p-0">
								<form:form id="frm01" action="/member/csc/inquiryModifyPost?${_csrf.parameterName}=${_csrf.token}" method="post" enctype="multipart/form-data" class="row g-4">
									<!-- 제목 -->
									<div class="col-md-12">
