...
$(function() {
	...
	function chkEmailConfirm(data, $emailConfirm) {
		...
		$("#btnResetPwConfirm").on("click", function() {
			...
			$.ajax({
				type : "POST",
				url : "/member/email/resetPwByEmail",
				data : JSON.stringify(data),
				contentType : "application/json;charset=utf-8",
				beforeSend : function (xhr) {
									...
									<div class="p-4 p-sm-7">
										...
										<form class="mt-sm-4 text-start">
											...
											<div class="mb-3 text-center">
												<p>
													<a href="/member/sign/signIn">로그인 화면으로<span style="color:#85878A">으로 돌아가기</span></a>
												</p>
											</div>
											...
											<div class="d-grid">
												<button type="button" id="btnResetPw"
													class="btn btn-primary" disabled="true">비밀번호 재설정</button>
											</div>
					...
					<div class="modal-body p-3">
						...
						<div>
							<button type="button" id="btnResetPwConfirm"
								class="btn btn-primary w-100 mb-0" disabled="true">재설정</button>
