	...
	<div class="container">
		<div class="row">
			<div class="col-lg-10 mx-auto text-center">
				...
				<h1>이전 문의 내역</h1>
				<!-- Info -->
				<p class="text-primary">wonderWay 문의 내역</p>
				<!-- Search -->
					...
					<table class="table align-middle p-4 mb-0 table-hover table-shrink">
						...
						<thead class="table-light">
							<tr>
								...
								<th scope="col" class="border-0 ">문의 날짜</th>
								<th scope="col" class="border-0 ">답변 상태</th>
						...
						<c:forEach var="brdVO" items="${data.content}" varStatus="stat">
							<tbody class="border-top-0">
								...
								<tr>
									...
									<td>
										<a href="/member/csc/inquiryDetail?brdId=${brdVO.brdId}"><h6 class="mb-0">${brdVO.brdTt}</h6></a>
									</td>
					...
					<div class="d-sm-flex justify-content-sm-between align-items-sm-center">
						...
						<nav class="mb-sm-0 d-flex justify-content-center" aria-label="navigation">
							<ul class="pagination pagination-sm pagination-primary-soft mb-0 ">
								...
								<li class="page-item">
									<a class="page-link" href="/member/csc/inquiryRegistration">문의하기</a>
								</li>
							</ul>
						</nav>
					</div>
