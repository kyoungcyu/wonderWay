...
<div class="container vstack gap-4">
		...
		<div class="row">
			<div class="col-12">
				<h1 class="fs-4 mb-0">
					<i class="bi bi-car-front fa-fw me-1"></i>차량 번호판 인식
				</h1>
			</div>
		</div>
		<!-- Title END -->
			...
			<div class="col-12">
				<div class="card border h-100">
					...
					<div class="card-header border-bottom">
						<h5 class="card-header-title">차량 번호판을 인식하여 로봇팔 차단기 개방</h5>
					</div>
					<!-- Card header END -->
					...
					<div class="card-body">
						<video width="640" height="640" controls>
							<source src="/resources/upload/carNum/carNumTesting.mp4" type="video/mp4">
