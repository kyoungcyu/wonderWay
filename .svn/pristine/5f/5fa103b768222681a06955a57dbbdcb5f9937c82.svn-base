	...
	<div class="container-fluid p-0">
		<div class="d-flex align-items-center w-100">
			...
			<div class="d-flex align-items-center d-xl-none">
				<a class="navbar-brand" href="/business/main"> <img
			...
			<ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
				...
				<li class="nav-item dropdown"><a
					...
					aria-expanded="false">원더머니 : <span style="font-size: large;">
					<fmt:formatNumber value="<%=sessionVO.getBusiMny()%>" pattern="#,###" />
					</span></a>
					<ul class="dropdown-menu dropdown-animation"
						aria-labelledby="pagesMenu">
						<li><a class="dropdown-item" href="/business/myPage/bank">출금 관리</a></li>
				...
				</a> <!-- Notification dote --> <span id="badgeBlink"
					...
					<div
						...
						<div class="card bg-transparent">
							...
							<div
								...
								<h6 class="m-0">
									Notifications <span id="alarmNumber"
										class="badge bg-danger bg-opacity-10 text-danger ms-2">00</span>
								</h6>
				...
				<li class="nav-item ms-3 dropdown">
					...
					aria-expanded="false"> <img class="avatar-img rounded-2"
						src="/resources/upload/busi${img.getBusiImg()}" alt="avatar">
				</a>
					...
					<ul
							...
							<div class="d-flex align-items-center">
								...
								<div class="avatar me-3">
									<img class="avatar-img rounded-circle shadow"
										src="/resources/upload/busi${img.getBusiImg()}"
										alt="avatar">
								</div>
								<div>
									<a class="h6 mt-2 mt-sm-0">${img.rprsvNm} 사장님</a>
									<p class="small m-0">${img.busiEmail}</p>
								</div>
							</div>
						</li>
						...
						<li><a class="dropdown-item" href="/business/myPage/detail"><i
								class="bi bi-bookmark-check fa-fw me-2"></i>나의 정보 변경</a></li>

						<li><a class="dropdown-item" href="/business/myPage/bank"><i
								class="bi bi-cash-stack fa-fw me-2"></i>출금 관리</a></li>

						<li><a class="dropdown-item bg-danger-soft-hover"
							href="/business/log/bsSignIn"><i
	...
	$(document).ready(
			function() {
				...
				socketAlm.onmessage = function(event) {
					...
					var busiId = '<%=session.getAttribute("vo") != null ? ((BusiVO) session.getAttribute("vo")).getBusiId() : ""%>	';
							if (alarmVO.receiver === busiId) {

								// alarmContainer 요소 가져오기
								var alarmContainer = document
										.getElementById("alarmContainer");
				...
				.ajax({
					...
					success : function(result) {
						...
						var ulElement = document
								.getElementsByClassName("list-group list-group-flush list-unstyled p-2");
						...
						if (listAlm.length == 0) {
							...
							document.getElementById("badgeBlink").setAttribute(
									"hidden", "hidden");
							...
							listAlm
									.forEach(function(data) {
										...
										document.getElementById("badgeBlink")
