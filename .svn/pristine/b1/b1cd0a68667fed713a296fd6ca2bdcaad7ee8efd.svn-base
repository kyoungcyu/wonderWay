...
<div class="page-content-wrapper p-xxl-4">
		...
		<div class="col-lg-4">
			<div class="card card-body border border-primary bg-primary bg-opacity-10 border-opacity-25 p-4 h-100">
				<div class="d-flex justify-content-between align-items-center">
					<!-- Digit -->
					<div>
						<h3 class="mb-0 fw-bold"><fmt:formatNumber value="${countCar}" pattern="#,###" /></h3>
						<span class="mb-0 h6 fw-light">차량 개수</span>
					</div>
					<!-- Icon -->
					...
					<div class="row">
						...
						<div class="col-md-6">
							<ul class="list-group list-group-borderless">
								...
								<li class="list-group-item mb-3">
									<span>업체 분류 : </span>
									<span class="h6 fw-normal ms-1 mb-0">${busiVO.busiCode eq 'B02' ? '렌터카' : '' }</span>
								</li>
	...
	<div class="row g-4">
		...
		<c:forEach var="carVO" items="${carList}" varStatus="stat">
			<div class="col-lg-6">
				<div class="card shadow p-3">
					<div class="row g-4">
						<!-- Card img -->
						<div class="col-sm-3">
							<c:if test="${not empty carVO.carImg}">
								<img src="${carVO.carImg}" class="rounded-2" alt="Card image">
							</c:if>
							<c:if test="${empty carVO.carImg}">
								<img src="/resources/booking/assets/images/car.png" class="rounded-2" alt="Card image">
							</c:if>
						</div>
						...
						<div class="col-sm-9">
							<div class="card-body position-relative d-flex flex-column p-0 h-100">
								<!-- Title -->
								<h5 class="card-title mb-0 me-5"><a href="hotel-detail.html">${carVO.carNum}</a></h5>
								<div class="d-flex justify-content-between align-items-center mt-3 mt-md-auto">
									<div class="d-flex align-items-center">
								    	<small><i class="bi bi-geo-alt me-2"></i>${carVO.carCode}</small>
								    </div>
								    <div class="d-flex align-items-center">
								    	<small>${carVO.carKnd}</small>
								    </div>
								</div>
								...
								<div class="d-flex justify-content-between align-items-center mt-3 mt-md-auto">
									<!-- Price -->
									<div class="d-flex align-items-center">
										<h5 class="fw-bold mb-0 me-1">₩ <fmt:formatNumber value="${carVO.carFee}" pattern="#,###" /></h5>
