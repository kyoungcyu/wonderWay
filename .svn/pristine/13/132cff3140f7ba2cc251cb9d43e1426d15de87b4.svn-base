				...
				<div class="card shadow mt-5">
					...
					<div class="card-body">
						...
						<c:forEach var="bsRfdListVO" items="${data.content}" varStatus="stat">
							<c:set var="formattedrfdDt">
							    <fmt:formatDate value="${bsRfdListVO.rfdDt}" pattern="yyyy/MM/dd" />
							</c:set>
							<div class="row row-cols-xl-7 align-items-lg-center border-bottom g-4 px-2 py-4">
								...
								<div class="col" style="text-align: center;">
									...
									<!-- 오늘 취소된 건은 new 뱃지 달기 -->
									<c:if test="${formattedrfdDt eq todayFormatted}">
										<ul id="newBadge" class="list-group list-group-borderless small mb-0 mt-2 animation-blink">
											<li class="list-group-item d-flex text-danger p-0">
												<i class="bi bi-patch-check-fill me-2"></i>new
											</li>
										</ul>
									</c:if>
								...
								<div class="col"style="text-align: center;">
									...
									<h6 class="mb-0 fw-normal">${bsRfdListVO.rmNum}호(${bsRfdListVO.rmNm})</h6>
								</div>
								...
								<div class="col"style="text-align: center;">
									...
									<c:if test="${bsRfdListVO.rsvCode eq '환불요청'}">
										...
										<a tabindex="0" class="h6 mb-0" role="button"
													...
													data-bs-content=" ${bsRfdListVO.rfdResn}"
													data-bs-original-title="환불 사유 :" title=""> 
													<i class="bi bi-info-circle small"></i>
												</a>
									</c:if>
									<c:if test="${bsRfdListVO.rsvCode eq '환불처리완료'}">
										<div class="badge bg-info bg-opacity-10 text-info">환불완료</div>
										<a tabindex="0" class="h6 mb-0" role="button"
													data-bs-toggle="popover" data-bs-trigger="focus"
													data-bs-placement="top"
													data-bs-content=" ${bsRfdListVO.rfdResn}"
					...
					<div class="card-footer pt-0">
						...
						<div
							...
							<!--Showing	${startRow} to ${endRow} of ${total} entries</p>-->
							<!-- Pagination -->
