		...
		<div class="row">
			<div class="col-md-10 col-xl-8 mx-auto">
				...
				<div id="pdfSection" class="card shadow">
					<!-- Image -->
					<img src="/resources/upload/busi${busiImg}" class="rounded-top" alt=""/>
						...
						<div class="row justify-content-between text-start mb-4">
							<div class="col-lg-5">
								<ul class="list-group list-group-borderless">
									...
									<li class="list-group-item d-sm-flex justify-content-between align-items-center">
										<span class="mb-0"><i class="bi bi-person fa-fw me-2"></i>이용자:</span>
										<span class="h6 fw-normal mb-0">${userNm}</span>
									</li>
									<li class="list-group-item d-sm-flex justify-content-between align-items-center">
							...
							<div class="col-lg-5">
								<ul class="list-group list-group-borderless">
									...
									<li class="list-group-item d-sm-flex justify-content-between align-items-center">
										...
										<span class="h6 fw-normal mb-0">${rStyPp}</span>
									</li>
								</ul>
							</div>
						</div>
