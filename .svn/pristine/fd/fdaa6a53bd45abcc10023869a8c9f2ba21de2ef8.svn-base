							...
							<div class="col-lg-12">
								<div class="card p-4">
									...
									<div class="card-body p-0">
										<form:form modelAttribute="brdVO" id="frm01" action="/admin/tour/magazineRegistPost" method="post" enctype="multipart/form-data" class="row g-4">
											<!-- 제목 -->
											<div class="col-md-7">
											...
											<div class="col-12 text-end" id="p2">
												<button type="button" class="btn btn-success mb-0" id="btnRegist">등록</button>
