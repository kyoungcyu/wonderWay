...
<section class="pt-0 pb-20">
	<div class="container">
		<!-- Background image -->
		<div class="rounded-3 p-3 p-sm-5" style="background-image: url(/resources/booking/assets/images/bg/01.jpg); background-position: center center; background-repeat: no-repeat; background-size: cover;">
			<!-- Banner title -->
			<div class="row"> 
				<div class="col-md-10 mx-auto text-center"> 
					<h1 class="text-dark display-3 pt-sm-5 my-5">항공권 예매</h1>
				</div>
			</div>
              ...
              <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4 position-relative">
                  <div class="form-border-transparent form-fs-lg bg-light rounded-3 h-100 p-3">
                    <!-- Input field -->
                    <label class="mb-1"><i class="bi bi-geo-alt me-2"></i>출발공항</label>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="form-border-transparent form-fs-lg bg-light rounded-3 h-100 p-3">
                    <!-- Input field -->
                    <label class="mb-1"><i class="bi bi-send me-2"></i>도착공항</label>
                    <select class="form-select js-choice" name="arrPlace" data-search-enabled="true">
                      <option value="">도착공항을 선택해주세요</option>
                      <option>서울</option>
                      <option>대전</option>
                      <option>West Virginia, Paris</option>
                    </select>
