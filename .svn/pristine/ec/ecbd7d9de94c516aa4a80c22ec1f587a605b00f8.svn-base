...
public class BsCalculController {
	...
	public String afterCalculate(Model model, HttpSession session 
		...
		String vatCalcul= bsCalculService.vatCalcul(calculMap);
		String feeCalcul= bsCalculService.feeCalcul(calculMap);
		model.addAttribute("sumCalcul",sumCalcul);
		model.addAttribute("vatCalcul",vatCalcul);
		model.addAttribute("feeCalcul",feeCalcul);
