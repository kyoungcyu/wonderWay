...
<body>
	...
	<div class="container vstack gap-4">
		...
		<div class="row">
			<div class="col-12">
				<h1 class="fs-4 mb-0">
					<i class="bi bi-caret-right-square fa-fw me-1"></i>무인 체크인 시연영상
				</h1>
			...
			<div class="col-12">
				<div class="card border h-100">
					...
					<div class="card-header border-bottom">
						<h5 class="card-header-title">얼굴인식으로 체크인하는  인공지능(기능)</h5>
					</div>
					<!-- Card header END -->
					...
					<div class="card-body">
						<video width="640" height="640" controls>
							<source src="/resources/upload/testing/faceTesting.mp4" type="video/mp4">
						</video>
					</div>
