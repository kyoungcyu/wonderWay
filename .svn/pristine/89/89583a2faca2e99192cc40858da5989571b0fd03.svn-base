		...
		<div class="container">
			<div class="row mb-4">
				...
				<div class="col-12 text-center">
					<h2 class="mb-0"><a href="/member/tripBoard/tripMain">여행후기 모음집</a></h2>
				</div>
			</div>
			...
			<form class="row g-4 align-items-center mb-4" id="frm01">
				...
				<div class="col-md-8 col-lg-4 offset-lg-4">
					<div class="rounded position-relative">
						<input class="form-control bg-transparent" type="search" placeholder="검색어를 입력해주세요" name="keyword" value="${param.keyword}"
							aria-label="Search">
					...
					<div class="col-md-6 col-lg-4">
						<div class="card bg-transparent">
							...
							<c:when test="${brdVO.savePath eq null || brdVO.savePath eq ''}">
									...
									<img src="/resources/upload/2023/06/26/2962b8ed-e9f2-4e60-ba56-c9fe93595cb4_다운로드.jpg" class="card-img" alt="">
								</a>
							</c:when>
							<c:otherwise>
								<a href="/member/tripBoard/tripDetail"> 
									<img src="/resources/upload/tripBoard${brdVO.savePath}" class="card-img" alt="">
								</a>
							</c:otherwise>
							</c:choose>
								<!-- Badge -->
								<div class="card-img-overlay p-3">
									...
									<i class="fa-solid fa-heart" style="color: #ffffff;"> ${brdVO.brdLike}</i></a>
								</div>
							</div>
