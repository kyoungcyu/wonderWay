...
public class AdBusiServiceImpl implements AdBusiService{
	...
	public List<AdBusiSalesVO> busiSalesList(Map<String, String> map) {
		return this.adBusiMapper.busiSalesList(map);
	}
	...
	public int getTotalSales(Map<String, String> map) {
		return this.adBusiMapper.getTotalSales(map);
	}

	@Override
	public int salesYear(String busiSearch) {
		return this.adBusiMapper.salesYear(busiSearch);
	}

	@Override
	public int salesMonth(String busiSearch) {
		return this.adBusiMapper.salesMonth(busiSearch);
	}

	@Override
	public List<AdBusiSalesVO> downloadExcel(Map<String, String> map) {
		return this.adBusiMapper.downloadExcel(map);
	};
