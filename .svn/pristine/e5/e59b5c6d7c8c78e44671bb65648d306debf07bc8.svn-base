							...
							<div class="card-body">
								...
								<div class="bg-light rounded p-3 d-none d-lg-block">
									<div class="row row-cols-7 g-4">
										...
										<div class="col" style="text-align: center;">
											<h6 class="mb-0">예약 일</h6>
										</div>
										<div class="col" style="text-align: center;">
											<h6 class="mb-0">숙박기간</h6>
										</div>
										<div class="col" style="text-align: center;">
								...
								<c:forEach var="bsRsvListVO" items="${data.content}" varStatus="stat">
									<c:set var="formattedRsvDt">
									    <fmt:formatDate value="${bsRsvListVO.rsvDt}" pattern="yyyy/MM/dd" />
									</c:set>
									<div class="row row-cols-xl-7 align-items-lg-center border-bottom g-4 px-2 py-4">
										
										<div class="col" style="text-align: center;">
											<small class="d-block d-lg-none">방이름</small>
												<c:if test="${formattedRsvDt eq todayFormatted}">
										...
										<div class="col" style="text-align: center;">
											<small class="d-block d-lg-none">예약 한날</small>
											<h6 class="mb-0 fw-normal">${formattedRsvDt}</h6>
										</div>

										<div class="col" style="text-align: center;">
											<small class="d-block d-lg-none">숙박 기간:</small>
